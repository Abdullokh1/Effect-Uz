    ...
    <aside className="aside">
      ...
      <div className="aside__weather">
        <div className="aside__inner d-flex align-items-center">
          ...
          <button
            style={{ opacity: slide >= arr.length - 1 ? "0.3" : "1" }}
            disabled={slide >= arr.length - 1 ? true : false}
            onClick={() => setSlide(slide + 1)}
          >
        ...
        <div className="aside__weather-listWrapper mt-2">
          <ul
            ...
            className="aside__weather-list d-flex"
          >
            {arr.map((item, i) => {
              return (
                <li key={i} className="d-flex justify-content-between">
                  <div>
                    <p>Quyoshli</p>
                    <span>
                      <span className="aside__temp">31</span> c /
                      <span className="aside__temp">25</span> c
                    </span>
                  </div>
