    ...
    <section className='sidebar'>
      <ul className='sidebar__list'>
        <NavLink className={({isActive}) => isActive ? 'active-link' : 'static-link'} to='/'>
          <li>
           <svg width={24} height={24} viewBox="true" x='true' fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <NavLink className={({isActive}) => isActive ? 'active-link' : 'static-link'} to='/News'>
          <li>
            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M9 12H20" stroke strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
              <path d="M9 18H20" stroke strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
              <path d="M5 6V6.01" stroke strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
            ...
            <div className="accordion" id="accordionExample">
              <div className="accordion-item">
                <h2 className="accordion-header" id="headingOne">
                  ...
                  <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9 4H5C4.44772 4 4 4.44772 4 5V9C4 9.55228 4.44772 10 5 10H9C9.55228 10 10 9.55228 10 9V5C10 4.44772 9.55228 4 9 4Z" stroke strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M19 4H15C14.4477 4 14 4.44772 14 5V9C14 9.55228 14.4477 10 15 10H19C19.5523 10 20 9.55228 20 9V5C20 4.44772 19.5523 4 19 4Z" stroke strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
        ...
        <NavLink className={({isActive}) => isActive ? 'active-link' : 'static-link'} to='qqq'>
          <li>
            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M15 5C15 3.34315 13.6569 2 12 2C10.3431 2 9 3.34315 9 5V10C9 11.6569 10.3431 13 12 13C13.6569 13 15 11.6569 15 10V5Z" stroke strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
              <path d="M5 10C5 11.8565 5.7375 13.637 7.05025 14.9497C8.36301 16.2625 10.1435 17 12 17C13.8565 17 15.637 16.2625 16.9497 14.9497C18.2625 13.637 19 11.8565 19 10" stroke='true' strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
